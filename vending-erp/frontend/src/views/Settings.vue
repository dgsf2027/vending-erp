...
/**
 * 设置中心 = 基础档案:机器与货道 / 商品 / 供应商 / 参数与阈值(旧版「基础档案」)。
 * 每一次改动都记 op_log:谁改的、改了什么,永远可查。资金账户 / AI 模型配置随「更多功能」模块收起。
 */
// 支持 /settings?tab=product 直达
const route = useRoute()
const validTabs = ['machine', 'product', 'supplier', 'params']
...
<template>
  <div class="ledger-page">
    ...
    <div class="ledger-title">
      <h2>设置中心</h2>
      <span class="sub">机器 · 商品 · 供应商 · 参数 —— 所有档案在这里增改</span>
    </div>
    <p class="ledger-note">
    ...
    <p class="ledger-foot-note">
      — 有历史流水的档案<b>永不删,只标停用</b>;商品的「参考成本」= 旧版的成本单价,没有进货史时按它算毛利 —
    </p>
  </div>
</template>
